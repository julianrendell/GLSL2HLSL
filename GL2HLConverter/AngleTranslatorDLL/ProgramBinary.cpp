...
bool ProgramBinary::defineUniform(GLenum shader, const Uniform &constant)
{
...
bool ProgramBinary::linkUniforms(ActiveUniforms vertexUniforms, ActiveUniforms fragmentUniforms)
{
